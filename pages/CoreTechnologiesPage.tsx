...
const GLOSSARY: Record<string, string> = {
    ...
    'CLG': 'GLOSSARY_CLG',
    'EHS': 'GLOSSARY_EHS',
    'DrillX': 'GLOSSARY_DrillX',
    'ThermoFluid': 'GLOSSARY_ThermoFluid',
    'Desal': 'GLOSSARY_Desal',
    'H2Cell': 'GLOSSARY_H2Cell',
    'EPCI': 'GLOSSARY_EPCI',
    'AgriCell': 'GLOSSARY_AgriCell',
    'LithiumLoop': 'GLOSSARY_LithiumLoop',
    'EcoCluster': 'GLOSSARY_EcoCluster',
    'SmartFund': 'GLOSSARY_SmartFund',
    'GeoCredit': 'GLOSSARY_GeoCredit',
};
                        ...
                        {technologies.map(tech => {
                            const relatedLinks = tech.relatedIds ? (
                                <div className="mt-4 pt-4 border-t border-gray-100 dark:border-slate-700">
                                    <span className="text-xs font-bold text-text-light dark:text-slate-400 uppercase tracking-wider mb-2 block">{t('RelatedTechnologies')}:</span>
                        ...
                        >
                            <div className="p-6">
                                <div className="flex justify-between items-center mb-8">
                                    <h3 className="text-sm font-bold text-text-light dark:text-slate-400 uppercase tracking-wider">{t('GlossaryTerm')}</h3>
                                    <button 
                                        onClick={() => setSelectedGlossaryTerm(null)}
                                ...
                                <div className="mb-6">
                                    ...
                                    <p className="text-lg font-medium text-text-dark dark:text-white leading-relaxed">
                                        {t(GLOSSARY[selectedGlossaryTerm] as TranslationKey)}
                                    </p>
                                </div>
